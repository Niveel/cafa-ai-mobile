  ...
  const data = useMemo<OnboardingSlide[]>(
    () => [
      ...
      },
      {
        ...
        description: t('onboarding.slide5.body'),
        icon: 'time-outline',
        accent: '#3A5D9A',
      },
      {
        ...
        description: t('onboarding.slide6.body'),
        icon: 'images-outline',
        accent: '#315493',
      },
      {
        ...
        description: t('onboarding.slide7.body'),
      ...
      },
      {
        ...
        description: t('onboarding.slide8.body'),
        icon: 'bar-chart-outline',
        accent: '#5F7FB8',
      },
      {
        id: 'real-time',
        title: t('onboarding.slide9.title'),
        description: t('onboarding.slide9.body'),
