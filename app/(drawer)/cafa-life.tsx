...
import { getCafaLifeHistory, useCafaLifeSession } from '@/features';
import { hapticSelection } from '@/utils';
import type { CafaLifeHistoryTurn, CafaLifeSessionState } from '@/types';
...
export default function CafaLifeScreen() {
  ...
  useEffect(() => {
    ...
    try {
      const result = AccessibilityInfo.announceForAccessibility(historyError) as unknown;
